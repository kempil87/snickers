            ...
            {cart.length === 0 ? (
                ...
                <>
                    <div style={{borderBottomStyle: "solid", borderBottomWidth: 2, borderBottomColor: "black"}}
                         className='d-flex justify-content-between align-items-center cart-top'>
                        <h5>КОРЗИНА</h5>
                    ...
                    <div>
                        {cart.map((i) => (
                            <div key={i._id} className='d-flex align-items-center flex-sm-row flex-column justify-content-between'>

                                <div className='m-2 d-flex justify-content-between align-items-center'>
                                    <img className='m-2 cart-img' width='120' height='120' src={i.image} alt='*'/>
                                    <div>
